# Luxembourg school case comparison: earlier pipeline outputs vs scalable architecture
...
| use case | metric | earlier output | current scalable architecture/cache | discrepancy |
|---|---:|---:|---:|---|
