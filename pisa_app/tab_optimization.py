...
def pisa_optimization(ss):
    ...
    with st.container():
        ...
        if (
            ...
            st.warning(
                "Please set a road network in the road network tab before continuing with the osm strategy."
            )
        st.text_input(
            "Mapbox access token",
        ...
        if (
            ss.network_type is None
            or ss.distance_type is None
        ):
            st.warning(
                "Please set a mode of transport and distance type in the road network tab before continuing."
            )
